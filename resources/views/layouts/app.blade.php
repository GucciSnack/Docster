                        ...
                        <div class="col-lg-2 d-none d-lg-block p-0 bg-light vh-100">
                            <div class="mt-5 pt-3">
                                <div class="list-group">
                                    ...
                                    <a href="{{ route('files') }}" class="list-group-item list-group-item-action border-0 p-4 bg-light">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon id="Shape" points="0 0 24 0 24 24 0 24"/>
                                        ...
                                        <span class="ml-2">@lang('app.pages.files')</span>
                                    </a>
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-0 p-4 bg-light d-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon id="Shape" points="0 0 24 0 24 24 0 24"/>
                                    ...
                                    <a href="{{ route('settings') }}" class="list-group-item list-group-item-action border-0 p-4 bg-light d-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect id="bound" x="0" y="0" width="24" height="24"/>
