    ...
    <div class="p-5 bg-light">
        <form method="POST" action="{{ route('account.update') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="first_name" type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" value="{{ old('first_name') ?? auth()->user()->first_name }}" required>
            ...
            <div class="form-group row">
                <label for="old-password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}</label>
